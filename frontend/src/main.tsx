...
const walletProviders = { wallets: [WalletId.PERA, WalletId.DEFLY] }
...
createRoot(document.getElementById('root')!).render(<WalletProvider value={walletProviders}><App/></WalletProvider>)
